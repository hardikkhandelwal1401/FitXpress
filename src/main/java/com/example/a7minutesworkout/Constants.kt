...
object Constants {
    fun defaultExerciseList():ArrayList<ExerciseModel>{
        ...
        val highKneesRunningInPlace=ExerciseModel(
            9,"High Knees Running In Place",R.drawable.ic_high_knees_running_in_place,false,false
        )
        ...
        val pushUpRotation=ExerciseModel(
            11,"Push Up Rotation",R.drawable.ic_push_up_rotation,false,false
        )
        exerciseList.add(pushUpRotation)

        val sidePlanks=ExerciseModel(
            12,"Side Planks",R.drawable.ic_side_plank,false,false
        )
